                        ...
                        <div className={styles.userMenuContainer} ref={dropdownRef}>
                            ...
                            {isDropdownOpen && (
                                <div className={`${styles.dropdownMenu} ${styles.show}`}>
                                    ...
                                    <button onClick={() => { setIsDropdownOpen(false); alert('Tính năng Cài đặt tài khoản đang được phát triển!'); }} className={styles.dropdownItem}>
                                    ...
                                    <button onClick={() => { setIsDropdownOpen(false); alert('Tính năng Thay đổi mật khẩu đang được phát triển!'); }} className={styles.dropdownItem}>
                                        <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '8px' }}>
                                            <path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"></path>
                                        </svg>
                                        Thay đổi mật khẩu
                                    </button>
                                    <button onClick={() => { setIsDropdownOpen(false); alert('Tính năng Truyện đã lưu đang được phát triển!'); }} className={styles.dropdownItem}>
                                        <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '8px' }}>
                                            <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
                                        </svg>
                                        Đã lưu
                                    </button>
                                    <button onClick={() => { setIsDropdownOpen(false); alert('Tính năng Lịch sử đọc đang được phát triển!'); }} className={styles.dropdownItem}>
                                        <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '8px' }}>
